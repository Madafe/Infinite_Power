...
## Pendientes — migrados a ClickUp (21/ago/2026)

**Este documento deja de trackear pendientes activos.** El checklist
maestro numerado (45 puntos) y la tabla de "Orden de construcción vigente"
que vivían aquí se movieron a ClickUp, board **Infinite Power**
(`901411740278`) — decisión de Mateo, 21/ago: "vamos a mover todo a
ClickUp". Este archivo sigue siendo la bitácora histórica de decisiones y
construcción (todo lo de arriba de esta sección se conserva tal cual, es
trazabilidad, no un tracker vivo) — pero para saber qué falta hacer, la
fuente de verdad es ClickUp, no este archivo. Ver `estado_del_proyecto.md`
para el estado real resumido y `docs/decisiones_arquitectura.md` para el
detalle de esta migración.
